...
public class Stream_03_Test {
	...
	// autre ecriture : générer un comparator avec comparing 
	...
	public void test_flatMap() throws Exception {
		...
		// transformer la liste de pizza en stream avec stream()
	...
	public void test_partitionning() throws Exception {
		...
		Map<Boolean, List<Pizza>> result = pizzas.stream().collect(Collectors.partitioningBy(p->p.getName().substring(0,1).contains("L")));
